					...
					<div class="col-md-10 col-md-push-2">
						<div class="row row-pb-lg">
							...
							<?php
								...
								{
									$select_qry = "select * from product order by cat_id asc";
											...
											<div class="cart">
												<form action="" method="post" class="form-submit">
													<p>
														...
														<span class="addItemWish"><a href="wishlist.php"><i class="icon-heart3"></i></a></span>
										...
										<div class="panel panel-default">
											...
											?>
												...
												<div class="panel-body">
													<?php
														$subcat_qry = "select * from subcategories where cat_id = $cat_id order by subcat_id asc";
