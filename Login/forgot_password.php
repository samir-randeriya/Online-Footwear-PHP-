...
<html lang="en">
<head>
	<title>Online Footwear | Forgot Password</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<?php
	    			...
	    			//public var $error;
	    				...
	    				if (!$email) {
		    				...
		    				$sel_query = "SELECT * FROM `registration` WHERE email_id='".$email."'";
		    				$results = mysqli_query($link,$sel_query);
		    				$row = mysqli_num_rows($results);
		    				if ($row==""){
                				$error = "<p>No user is registered with this email address!</p>";
                				//$error = '<script>alert("No user is registered with this email address!")</script>';
	    				...
	    				if($error!=""){
		    				...
		    				$output.='<p>-------------------------------------------------------------</p>';
		    				$output.='<p><a href="http://localhost/Online_Footwear/Login/reset_password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">Reset Password</a></p>';		
		    				$output.='<p>-------------------------------------------------------------</p>';
		    				...
		    				$output.='<p>Thanks,</p>';
		    				$output.='<p>Smart Footwear team</p>';
		    				$body = $output; 
		    				$subject = "Password Recovery - Smart Footwear";

		    				$email_to = $email;
		    				$fromserver = "smartfootwear1212@gmail.com"; //smartfootwear12@gmail.com
		    				...
		    				$mail->SMTPAuth = true;
		    				//$mail->SMTPDebug = 2;
		    				$mail->Username = "smartfootwear1212@gmail.com"; // Enter your email here
		    				$mail->Password = "footwear1212"; //Enter your password here //footwear1212
		    				$mail->SMTPSecure ='tls';	
		    				$mail->Port = 587; //25 //587

		    				$mail->IsHTML(true);
		    				$mail->From = "smartfootwear1212@gmail.com";
		    				$mail->FromName = "Smart Footwear";
				...
				?>	
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Email Id is required">
